<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="lerning.aspx.cs" Inherits="lerning" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" Runat="Server">
	...
	<div style="height: 404px; width: 872px">
    <table style="width: 100%; height: 388px; background-color: #FFFFFF;">
        <tr>
            <td align="center" colspan="2" style="vertical-align: top; " class="auto-style1">
                <img id="ctl00_cphMain_LearningChart1_Image1" 
                    src="IMAGES/a12.jpg"
                    style="border-width: 0px;" class="auto-style2" />
            </td>
        </tr>
        <tr>
            <td class="style1" colspan="2" style="vertical-align: top; text-align: justify">
                <span style="color: midnightblue; font-family: Palatino Linotype;">Soweto FET College has a wide network of Study, work and Programme centers through which it reaches 
                out to its students
                <br />
